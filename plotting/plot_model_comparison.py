...
legend_elements = [
Line2D([0], [0], color='orange', lw=2, label='Alfvén wing (Open Parker Spiral)'),
Line2D([0], [0], color='blue', lw=2, label='Reconnection (Open Parker Spiral)'),
Line2D([0], [0], color='orange', linestyle='dotted', lw=2, label='Alfvén wing (Dipole)'),
Line2D([0], [0], color='blue', linestyle='dotted', lw=2, label='Reconnection (Dipole)'),
...
Line2D([0], [0], color='orange', linestyle='dashed', lw=2, label='Alfvén wing (PFSS-Parker)'),
Line2D([0], [0], color='blue', linestyle='dashed', lw=2, label='Reconnection (PFSS-Parker)'),
]
...
ax2.set_xscale('log')
ax2.set_yscale('log')
ax2.plot(bsw_parker[STUDY], bsw_parker['Bsw'], color='blue')
ax2.plot(bsw_dipole[STUDY], bsw_dipole['Bsw'], color='blue', linestyle='dotted')
#ax2.plot(bsw_hybrid[STUDY], bsw_hybrid['Bsw'], color='blue', linestyle='dashed')
ax2.plot(bsw_pffs_parker[STUDY], bsw_pffs_parker['Bsw'], color='blue', linestyle='dashed')
legend_elements = [
Line2D([0], [0], color='blue', lw=2, label='Open Parker Spiral'),
Line2D([0], [0], color='blue', linestyle='dotted', lw=2, label='Dipole'),
#Line2D([0], [0], color='blue', linestyle='dashed', lw=2, label='Hybrid'),
Line2D([0], [0], color='blue', linestyle='dashed', lw=2, label='PFSS-Parker'),
]
...
ax2.set_xscale('log')
ax2.set_yscale('log')
ax2.plot(bsw_parker[STUDY], bsw_parker['M_A'], color='black')
ax2.plot(bsw_dipole[STUDY], bsw_dipole['M_A'], color='black', linestyle='dotted')
...
legend_elements = [
Line2D([0], [0], color='black', lw=2, label='Open Parker Spiral'),
Line2D([0], [0], color='black', linestyle='dotted', lw=2, label='Dipole'),
#Line2D([0], [0], color='black', linestyle='dashed', lw=2, label='Hybrid'),
Line2D([0], [0], color='black', linestyle='dashed', lw=2, label='PFSS-Parker'),
]
